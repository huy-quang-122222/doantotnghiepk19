# Generated by Django 4.2.5 on 2023-11-25 13:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Quantity', models.IntegerField(verbose_name='Số Lượng (cây)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name_plural': 'Ảnh Đại Diện',
            },
        ),
        migrations.CreateModel(
            name='PlantingPlan',
        ...
        migrations.AddField(
            model_name='fruit',
            name='Location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quantri.location', verbose_name='Địa điểm trồng'),
        ),
        migrations.CreateModel(
            name='Feedback',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('care_date', models.DateField(verbose_name='Ngày chăm sóc')),
        ...
        migrations.AddField(
            model_name='article',
            name='FruitID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quantri.fruit', verbose_name='Thuộc trái cây'),
        ),
        migrations.AddField(
            model_name='article',
            name='User',

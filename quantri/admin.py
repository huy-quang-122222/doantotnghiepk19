...
class FeedbackAdmin(admin.ModelAdmin):
    ...
    list_filter = ( 'is_read',)
    search_fields = ('User__username', 'Content')  # Tìm kiếm theo tên người dùng và nội dung
admin.site.register(Feedback, FeedbackAdmin)

class FruitAdmin(admin.ModelAdmin):
    list_display = ('FruitID', 'FruitName', 'PlantingTime', 'HarvestTime', 'Quantity', 'Location')
    list_filter = ('Location',)
    search_fields = ('FruitName', 'Location__LocationName')  # Tìm kiếm theo tên loại trái cây và tên địa điểm
